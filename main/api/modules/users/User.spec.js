  ...
  describe('User', function () {
    ...
    describe('setPassword', function () {
      ...
      describe('simple call', function () {
        it('hashs and store the password of the user', function (done) {
          ...
          user.setPassword('1234', factor, logger).then(function () {
      ...
      describe('bcrypt error', function () {
        it('rejects the promise with bcryptError', function (done) {
          ...
          user.setPassword('1234', factor, logger).then(null, function (err) {
    ...
    describe('checkPassword', function () {
      ...
      beforeEach(function () {
        ...
        var hash = '$2a$04$wp/Yh.0/NVnCWQJGqSlE5OZM7RB4c1MwYuiAfEoJAewiinA3PvpH6';
      ...
      describe('valid password', function () {
        ...
        describe('fastCall > 200ms', function () {
          it('calls success function and logs warning', function (done) {
            ...
            user.checkPassword('1234', logger).then(function () {

              expect(logger.warn.calledOnce).to.be.true;
              expect(logger.warn.getCall(0).args[0].elapsed).to.be.equals(100);
              done();
        ...
        describe('slowCall > 500ms', function () {
          it('calls success function and logs warning', function (done) {
            ...
            user.checkPassword('1234', logger).then(function () {
              ...
              expect(logger.warn.calledOnce).to.be.true;
              expect(logger.warn.getCall(0).args[0].elapsed).to.be.equals(501);
              done();
      ...
      describe('invalid password', function () {
        ...
        describe('fastCall > 200ms', function () {
          it('calls error funcion', function (done) {
            ...
            .onFirstCall().returns(0);
            user.checkPassword('wrong', logger).then(null, function (err) {
